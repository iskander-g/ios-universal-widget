...
class TodayView4Controller: UIViewController, UITableViewDataSource, UITableViewDelegate, NCWidgetProviding {
    ...
    override func viewDidLoad() {
        ...
        if (widgets != nil && widgets![3] as? String != nil) {
            
            self.url = widgets![3] as! String
