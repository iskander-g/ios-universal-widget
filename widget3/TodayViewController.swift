...
class TodayView3Controller: UIViewController, UITableViewDataSource, UITableViewDelegate, NCWidgetProviding {
    ...
    override func viewDidLoad() {
        ...
        if (widgets != nil && widgets![2] as? String != nil) {
            
            self.url = widgets![2] as! String
