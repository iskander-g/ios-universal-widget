...
class TodayView2Controller: UIViewController, UITableViewDataSource, UITableViewDelegate, NCWidgetProviding {
    ...
    override func viewDidLoad() {
        ...
        if (widgets != nil && widgets![1] as? String != nil) {
            
            self.url = widgets![1] as! String
